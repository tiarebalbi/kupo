...
<div class="page-title">
	<i class="fa-key fa"></i>
	<h3>
		<spring:message code="nav.administracao.principal.sub.servicos" />
	</h3>
</div>
	...
	<div class="col-md-12">
		<div class="grid simple ">
			<div class="grid-title no-border">
				<a href="${path}administracao/servicos/novo" class="btn btn-small btn-info"><i class="fa fa-plus"></i> <spring:message code="servicos.btn.novo" /></a>
				<div class="tools">
			...
			<div class="grid-body no-border">
				...
				<table class="table no-more-tables table-striped">
					<thead>
						<tr>
							...
							<th><spring:message code="system.version" /></th>
				...
				{{#each []}}
					<tr data-line-id="{{this.attributes.id}}">
						...
						<td>{{this.attributes.version}}</td>
						<td>
							<div class="btn-group"> 
								<a class="btn btn-info dropdown-toggle btn-small" data-toggle="dropdown" href="#"> ${opcoes} <span class="caret"></span> </a>
                    			<ul class="dropdown-menu">
                      				<li><a href="${path}administracao/servico/planos/{{this.attributes.id}}"><i class='fa fa-briefcase'></i> Planos do Serviço</a></li>
									<li><a href="${path}administracao/servicos/editar/{{this.attributes.id}}"><i class='fa fa-edit'></i> Editar</a></li>
                      				<li class="divider"></li>
                      				<li><a href="${path}administracao/servicos/excluir/{{this.attributes.id}}"><i class='fa fa-minus-circle'></i> Excluir</a></li>
                    			</ul>
                  			</div>
						</td>
					</tr>
