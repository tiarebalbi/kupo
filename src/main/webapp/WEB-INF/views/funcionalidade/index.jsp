	...
	<div class="col-md-12">
		<div class="grid simple ">
			<div class="grid-title no-border">
				<a href="${path}administracao/servico/funcionalidades/novo" class="btn btn-small btn-info"><i class="fa fa-plus"></i> <spring:message code="funcionalidades.btn.novo" /></a>
				<div class="tools">
			...
			<div class="grid-body no-border">
				<h3>
					<spring:message code="funcionalidades.btn.listagem" /> <span class="semi-bold"><spring:message code="funcionalidades.btn.nome.plural" /></span>
				</h3>
				<table class="table no-more-tables table-striped">
					<thead>
						<tr>
							<th>#ID</th>
							<th><spring:message code="funcionalidades.btn.nome.singular" /></th>
							<th><spring:message code="funcionalidades.column.totalregras" /></th>
				...
				{{#each []}}
					<tr data-line-id="{{this.attributes.id}}">
						...
						<td>{{this.attributes.regras.size}}</td>
						<td>
							<div class="btn-group"> 
								<a class="btn btn-info dropdown-toggle btn-small" data-toggle="dropdown" href="#"> ${opcoes} <span class="caret"></span> </a>
                    			<ul class="dropdown-menu">
                      				<li><a href="${path}administracao/servico/funcionalidades/editar/{{this.attributes.id}}"><i class='fa fa-edit'></i> Editar</a></li>
                      				<li class="divider"></li>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-footer">
											...
											<a href="${path}administracao/servico/funcionalidades/excluir/{{this.attributes.id}}" class="btn btn-danger destroy"> <spring:message code="usuario.btn.destroy" /> </a>
										</div>
									</div>
									<!-- /.modal-content -->
								</div>
